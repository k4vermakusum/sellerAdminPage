...
function onSumbit(e){
  ...
  axios.post("https://crudcrud.com/api/f4e63036caaa49878503be7490e512a7/apointmentdata",obj)
  .then((response)=>{
 ...
 async function display_details(){
   ...
   skin_items.innerHTML="";
    ...
    const response=await axios.get("https://crudcrud.com/api/f4e63036caaa49878503be7490e512a7/apointmentdata");
    ...
    for(let i=0;i<orders.length;i++){
        ...
        deletebtn.onclick=(async()=>{
         await axios.delete(`https://crudcrud.com/api/f4e63036caaa49878503be7490e512a7/apointmentdata/${order._id}`)
